...
%\noindent\framebox[\textwidth][c]{\begin{minipage}{\textwidth}\begin{center}#1\end{center}\end{minipage}} % Makes the box around the problem answer and puts the content inside
\noindent
 \begin{center} 
    \boxed{
      \begin{aligned} 
