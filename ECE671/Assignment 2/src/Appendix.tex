...
\includepdf[scale=.9,pages=1,clip,trim=0cm 3cm 0cm
0cm,pagecommand=\subsubsection{High Gain Amplifier}]{../res/DesignA2P1Mathematica.pdf}
\includepdf[scale=.9,pages=2-,clip,trim=0cm 3cm 0cm
0cm,pagecommand={}]{../res/DesignA2P1Mathematica.pdf}

% Low Noise Amplifier Mathematica
\includepdf[scale=.9,pages=1,clip,trim=0cm 3cm 0cm
0cm,pagecommand=\subsubsection{Low Noise Amplifier}]{../res/DesignA2P2Mathematica.pdf}

\includepdf[scale=.9,pages=2-,clip,trim=0cm 3cm 0cm
0cm]{../res/DesignA2P1Mathematica.pdf}
...
\includepdf[scale=.9,pages=1,clip,trim=0cm 0cm 0cm
0cm,pagecommand=\subsubsection{High Gain Amplifier}]{../res/DesignA2P1.pdf} 

\includepdf[scale=.9,pages=2-,clip,trim=0cm 0cm 0cm
