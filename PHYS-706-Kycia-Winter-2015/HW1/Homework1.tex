...
\usepackage[utf8]{inputenc}
 ...
 \usepackage{graphicx}
 \usepackage[bookmarks=false,pdffitwindow,dvipdfm]{hyperref}
 \usepackage{tikz}
 \usepackage{xcolor}
 \usepackage{calc}
\usepackage{chngcntr}
...
\date{January 23, 2015} % Insert date here if you want it to appear below your name
...
Note: I will be using $k \equiv \frac{1}{4\pi \epsilon_0}$ throughout this homework set. I will clear up any ambiguity that may arise.
